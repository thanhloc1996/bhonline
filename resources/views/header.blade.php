			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> 180 Cao Lỗ, Phường 4, Quận 8, Hồ Chí Minh</a></li>
						<li><a href=""><i class="fa fa-phone"></i>01683032891</a></li>
					</ul>
				</div>
			...
			<div class="container beta-relative">
				...
				<div class="pull-right beta-components space-left ov">
					...
					<div class="beta-comp">
						@if(Session::has('cart'))
							<div class="cart">
							<div class="beta-select"><i class="fa fa-shopping-cart"></i> Vỏ hàng  (@if(Session::has('cart'))
								...
								@foreach($product_cart as $product)
										<div class="cart-item">
											<a class="cart-item-delete" href="{{route('deletetocart',$product['item']['id'])}}" ><i class="fa fa-times"></i></a>
											<div class="media">
				...
				<nav class="main-menu" >
					...
					<li ><a href="{{route('index')}}"> Trang Chủ</a></li>
						<li><a href="">Loại Sản Phẩm</a>
							...
							<li><a href="{{route('type_product',$lsp->id)}}">{{$lsp->name}}</a></li>
								@endforeach
							</ul>
						</li>
