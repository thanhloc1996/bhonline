					    ...
					    <div class="banner" >
								<ul>
									...
									<div class="slotholder" style="width:100%;height:100%;" data-duration="undefined" data-zoomstart="undefined" data-zoomend="undefined" 
										data-rotationstart="undefined" data-rotationend="undefined" data-ease="undefined" data-bgpositionend="undefined" data-bgposition="undefined" data-kenburns="undefined" 
										data-easeme="undefined" data-bgfit="undefined" data-bgfitend="undefined" data-owidth="undefined" data-oheight="undefined">
													...
													data-lazydone="undefined" src="source/image/slide/{{$sl->image}}" data-src="source/image/slide/{{$sl->image}}" style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat;
			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-12">
									...
									<div class="single-item">
										...
										@endif
											<div class="single-item-header">
												<a href="{{route('product',$new->id)}}"><img src="source/image/product/{{$new->image}}" alt="" height="230px"></a>
											</div>
							...
							<div class="row">
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('product',$sale->id)}}"><img src="source/image/product/{{$sale->image}}" alt="" height="230px"></a>
										</div>
										<div class="single-item-body">
										...
										<div class="single-item-caption">
											<a class="add-to-cart pull-left" href="{{route('addtocart',$sale->id)}}"><i class="fa fa-shopping-cart"></i></a>
						...
						<div class="row" align = "center">{{$sale_product->links()}}</div>
